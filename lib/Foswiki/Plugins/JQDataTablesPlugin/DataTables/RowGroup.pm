...
package Foswiki::Plugins::JQDataTablesPlugin::DataTables::RowGroup;
...
sub new {
  ...
  return bless(
    $class->SUPER::new(
      $session,
      name => 'DataTablesRowGroup',
      version => '1.1.0',
      author => 'SpryMedia Ltd',
      homepage => 'http://datatables.net/',
      puburl => '%PUBURLPATH%/%SYSTEMWEB%/JQDataTablesPlugin',
      #css => ['RowGroup/css/rowGroup.dataTables.min.css'],
      javascript => ['RowGroup/js/dataTables.rowGroup.js'],
